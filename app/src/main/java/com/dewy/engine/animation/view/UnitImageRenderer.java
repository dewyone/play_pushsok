 ...
 */
public class UnitImageRenderer extends BaseRenderer20 {
    ...
    public UnitImageRenderer(GLContext GLContext) {
        super(GLContext);

        context = GLContext.getContext();
        textureShaderProgram = new TextureShaderProgram(context);

        texturePrimitiveData = UnitImageBuilder.createImage(Skbl.EMPTYSPACE, -0.5f, 0.5f, 0.15f);
